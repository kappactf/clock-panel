...
/***/ "../node_modules/css-loader/index.js?!./css/clock-panel.css":
/*!******************************************************************!*\
  !*** ../node_modules/css-loader??ref--5-1!./css/clock-panel.css ***!
  \******************************************************************/
...
// module
exports.push([module.i, ".clock-panel {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n", "", {"version":3,"sources":["/Users/opyakin-roman/github/clock-panel/src/css/clock-panel.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,oBAAoB;EACpB,wBAAwB;EACxB,uBAAuB;CACxB","file":"clock-panel.css","sourcesContent":[".clock-panel {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n"],"sourceRoot":""}]);
...
__webpack_require__(/*! ./external/moment-duration-format */ "./external/moment-duration-format.js");

var _lodash = __webpack_require__(/*! lodash */ "lodash");

var _lodash2 = _interopRequireDefault(_lodash);

__webpack_require__(/*! ./css/clock-panel.css */ "./css/clock-panel.css");
...
function (_super) {
  ...
  function ClockCtrl($scope, $injector) {
    ...
    _this.panelDefaults = {
      ...
      bgColor: null,
      countdownSettings: {
        endCountdownTime: (0, _moment2.default)().seconds(0).milliseconds(0).add(1, 'day').toDate(),
        endText: '00:00:00',
        customFormat: null
      },
      dateSettings: {
    ...
    if (!(_this.panel.countdownSettings.endCountdownTime instanceof Date)) {
      _this.panel.countdownSettings.endCountdownTime = (0, _moment2.default)(_this.panel.countdownSettings.endCountdownTime).toDate();
    }
  ...
  ClockCtrl.prototype.onInitEditMode = function () {
  ...
  ClockCtrl.prototype.onPanelTeardown = function () {
    this.$timeout.cancel(this.nextTickPromise);
  };

  ClockCtrl.prototype.updateClock = function () {
    this.$timeout.cancel(this.nextTickPromise);
  ...
  ClockCtrl.prototype.renderTime = function () {
    var now;
    ...
    if (this.panel.offsetFromUtc && this.panel.offsetFromUtcMinutes) {
      ...
      now = (0, _moment2.default)().utcOffset(offsetInMinutes);
    } else if (this.panel.offsetFromUtc && !this.panel.offsetFromUtcMinutes) {
      now = (0, _moment2.default)().utcOffset(parseInt(this.panel.offsetFromUtc, 10));
    } else {
  ...
  ClockCtrl.prototype.getTimeFormat = function () {
  ...
  ClockCtrl.prototype.renderCountdown = function () {
    var round_time = parseInt(this.panel.countdownSettings.roundTime);

    var time_left = _moment2.default.duration((0, _moment2.default)().diff((0, _moment2.default)(this.panel.countdownSettings.endCountdownTime)));

    var t = round_time - Math.round(time_left.asSeconds()) % round_time;

    var timeLeft = _moment2.default.duration(t, 'seconds');
  ...
  ClockCtrl.prototype.link = function (scope, elem) {
    var _this = this;

    this.events.on('render', function () {
      var $panelContainer = elem.find('.panel-container');

      if (_this.panel.bgColor) {
        $panelContainer.css('background-color', _this.panel.bgColor);
      } else {
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--5-1!./clock-panel.css */ "../node_modules/css-loader/index.js?!./css/clock-panel.css");
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! Moment Duration Format v2.2.1
...
var _clock_ctrl = __webpack_require__(/*! ./clock_ctrl */ "./clock_ctrl.ts");

exports.PanelCtrl = _clock_ctrl.ClockCtrl;
